package com.launchcode.section4;
...
public class CalculatorMethods
{
    ...
    public static void main(String args[])
    {
        ...
        //Tbe return value of add(), which is 12,
        //gets saved in the variable x
        int x=add(5,7);
        //Print out the value of x in out print statement
        ...
        System.out.println("9 divided by 3 is "+ divide(9,3));
        System.out.println("5 divided by 3 is "+divide(5,3));
